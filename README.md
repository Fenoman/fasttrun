...
Это пример жизненного цикла временной таблицы в нашем продакшн с пулером соединений:
...
```
fasttrun.c                    # основной C-код (~2900 строк)
fasttrun.control              # метаданные расширения
fasttrun--2.1.sql             # текущая версия (5 функций)
