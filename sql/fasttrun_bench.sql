...
--     железе это единицы-десятки мс; строгий SLO с настраиваемым
--     порогом живёт в scripts/check_fasttrun_perf_smoke.sh).
...
BEGIN
    ...
    /* Полный refresh на 1M строк × 50 колонок:
     * ~50-150 мс это нормально, 500 мс — тревожный порог регрессии */
...
BEGIN
    ...
    -- этот вызов идёт по delta-hit + full refresh, а не по
